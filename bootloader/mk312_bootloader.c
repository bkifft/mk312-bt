/* based on https://www.mikrocontroller.net/articles/AVR_Bootloader_in_C_-_eine_einfache_Anleitung

- only using ihex, ignoring .upg encryption.
- unsure how it will get triggered for now, keypressed on powerup like the original is the best option for now
